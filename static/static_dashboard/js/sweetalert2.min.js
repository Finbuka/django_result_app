!function(t, e) {
    ...
    var e = "SweetAlert2:"
      ...
      , J = function(t) {
        ...
        !O()) {
            ...
            o.appendChild(n);
            var i, r = w(), a = B(), s = _(a, I.input), c = _(a, I.file), u = a.querySelector(".".concat(I.range, " input")), l = a.querySelector(".".concat(I.range, " output")), d = _(a, I.select), p = a.querySelector(".".concat(I.checkbox, " input")), f = _(a, I.textarea);
            ...
            "rtl" === window.getComputedStyle(o).direction && D(v(), I.rtl);
            var m = function(t) {
                Et.isVisible() && i !== t.target.value && Et.resetValidationMessage(),
                i = t.target.value
            };
            return s.oninput = m,
            c.onchange = m,
      ...
      , tt = function(t) {
        var e = F()
          , n = S()
          , o = L();
        if (t.showConfirmButton || t.showCancelButton ? z(e) : W(e),
        ...
        t.buttonsStyling) {
            D([n, o], I.styled),
            t.confirmButtonColor && (n.style.backgroundColor = t.confirmButtonColor),
      ...
      , et = function(t) {
        ...
        t.html ? X(t.html, e) : t.text ? (e.textContent = t.text,
        z(e)) : W(e)
    }
      , nt = function(t) {
        ...
        if (t.type)
            if (-1 !== Object.keys(f).indexOf(t.type)) {
                ...
                t.animation && D(o, "swal2-animate-".concat(t.type, "-icon"))
            } else
                H('Unknown type! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.type, '"'))
    }
      , ot = function(t) {
        var e = x();
        ...
        t.customClass && D(e, t.customClass.image)) : W(e)
    }
      , it = function(i) {
        var r = A()
          , a = parseInt(null === i.currentProgressStep ? Et.getQueueStep() : i.currentProgressStep, 10);
        i.progressSteps && i.progressSteps.length ? (z(r),
        r.innerHTML = "",
        a >= i.progressSteps.length && q("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
        i.progressSteps.forEach(function(t, e) {
            var n = document.createElement("li");
            if (D(n, I["progress-step"]),
            n.innerHTML = t,
      ...
      , mt = Object.freeze({
        ...
        queue: function(t) {
            ...
            return new Promise(function(i) {
                !function e(n, o) {
                    n < at.length ? (document.body.setAttribute("data-swal2-queue-step", n),
    ...
    function ht() {
        ...
        t.showConfirmButton || (W(e.confirmButton),
        t.showCancelButton || W(e.actions)),
            ...
            var s = function() {
                T() ? kt(a) : (new Promise(function(t) {
                    ...
                    ct.restoreFocusTimeout = setTimeout(function() {
                        ct.previousActiveElement && ct.previousActiveElement.focus ? (ct.previousActiveElement.focus(),
                        ct.previousActiveElement = null) : document.body && document.body.focus(),
                        t()
                    }, 100),
                ...
                U([document.documentElement, document.body], [I.shown, I["height-auto"], I["no-backdrop"], I["toast-shown"], I["toast-column"]]),
                E() && (null !== m.previousBodyPadding && (document.body.style.paddingRight = m.previousBodyPadding + "px",
                ...
                "undefined" != typeof window && bt() && window.removeEventListener("resize", yt),
    ...
    var At = function(t) {
        ...
        t.animation ? (D(n, I.show),
        D(e, I.fade),
        U(n, I.hide)) : U(n, I.fade),
        z(n),
        ...
        t.heightAuto && t.backdrop && !t.toast && D([document.documentElement, document.body], I["height-auto"]),
        E() && (t.scrollbarPadding && vt(),
        function() {
        ...
        T() || ct.previousActiveElement || (ct.previousActiveElement = document.activeElement),
        ...
        _main: function(t) {
            ...
            !function(t) {
                for (var e in t)
                    ...
                    t.toast && -1 !== dt.indexOf(e) && q('The parameter "'.concat(e, '" is incompatible with toasts')),
                    ft(e) && (n = 'The parameter "'.concat(e, '" is deprecated and will be removed in the next major release. Please use "').concat(ft(e), '" instead.'),
            ...
            !function(e) {
                ...
                (!e.target || "string" == typeof e.target && !document.querySelector(e.target) || "string" != typeof e.target && !e.target.appendChild) && (q('Target parameter is not valid, defaulting to "body"'),
                e.target = "body"),
                ...
                null !== e.padding && (t.style.padding = "number" == typeof e.padding ? e.padding + "px" : e.padding),
                ...
                if (rt(e),
                et(e),
                "string" == typeof e.backdrop ? v().style.background = e.backdrop : e.backdrop || D([document.documentElement, document.body], I["no-backdrop"]),
                !e.backdrop && e.allowOutsideClick && q('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
                e.position in I ? D(s, I[e.position]) : (q('The "position" parameter is not valid, defaulting to "center"'),
                D(s, I.center)),
                ...
                z(c)) : W(c),
                t.className = I.popup,
                e.toast ? (D([document.documentElement, document.body], I["toast-shown"]),
                D(t, I.toast)) : D(t, I.modal),
                e.customClass && (D(s, e.customClass.container),
                D(t, "string" == typeof e.customClass ? e.customClass : e.customClass.popup),
                ...
                tt(e),
                X(e.footer, f),
                !0 === e.animation ? U(t, I.noanimation) : D(t, I.noanimation),
            ...
            return new Promise(function(t) {
                ...
                T.timer && (ct.timeout = new Bt(function() {
                    s("timer"),
                    delete ct.timeout
                }
                ,T.timer)),
                    ...
                    case "click":
                        if (i)
                            ...
                            T.input) {
                                ...
                                T.inputValidator ? (E.disableInput(),
                                Promise.resolve().then(function() {
                                    return T.inputValidator(a, T.validationMessage)
                                }).then(function(t) {
                                    E.enableButtons(),
                                    E.enableInput(),
                                    t ? E.showValidationMessage(t) : c(a)
                                })) : E.getInput().checkValidity() ? c(a) : (E.enableButtons(),
                ...
                T.toast)
                    ...
                    O.container.onmousedown = function() {
                        O.popup.onmouseup = function(t) {
                            ...
                            (t.target === O.popup || O.popup.contains(t.target)) && (r = !0)
                        }
                    }
                    ,
                ...
                ct.keydownHandlerAdded = !1),
                T.toast || (ct.keydownHandler = function(t) {
                    return function(t, e) {
                        ...
                        "Enter" !== t.key || t.isComposing)
                            if ("Tab" === t.key) {
                                ...
                                -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(t.key) ? document.activeElement === O.confirmButton && K(O.cancelButton) ? O.cancelButton.focus() : document.activeElement === O.cancelButton && K(O.confirmButton) && O.confirmButton.focus() : "Escape" !== t.key && "Esc" !== t.key || !0 !== j(e.allowEscapeKey) || (t.preventDefault(),
                ...
                ,
                ct.keydownTarget = T.keydownListenerCapture ? window : O.popup,
                ct.keydownListenerCapture = T.keydownListenerCapture,
                ct.keydownTarget.addEventListener("keydown", ct.keydownHandler, {
                    capture: ct.keydownListenerCapture
                }),
                ...
                T.toast && (T.input || T.footer || T.showCloseButton) ? D(document.body, I["toast-column"]) : U(document.body, I["toast-column"]);
                ...
                case "url":
                    ...
                    "string" == typeof T.inputValue || "number" == typeof T.inputValue ? u.value = T.inputValue : R(T.inputValue) || q('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(V(T.inputValue), '"')),
                    p(u),
                    u.type = T.input,
                    z(u);
                    break;
                ...
                case "select":
                    ...
                    l = function(t) {
                        t.forEach(function(t) {
                            ...
                            o.value = e,
                            o.innerHTML = n,
                            T.inputValue.toString() === e.toString() && (o.selected = !0),
                            k.appendChild(o)
                        }),
                        z(k),
                        k.focus()
                ...
                case "radio":
                    ...
                    l = function(t) {
                        t.forEach(function(t) {
                            ...
                            o.name = I.radio,
                            o.value = e,
                            T.inputValue.toString() === e.toString() && (o.checked = !0);
                ...
                case "checkbox":
                    ...
                    A.querySelector("span").innerHTML = T.inputPlaceholder,
                    z(A);
                    break;
                case "textarea":
                ...
                if ("select" === T.input || "radio" === T.input) {
                    ...
                    R(T.inputOptions) ? (M.showLoading(),
                    ...
                    -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(T.input) && R(T.inputValue) && (M.showLoading(),
                    W(u),
                    T.inputValue.then(function(t) {
                        u.value = "number" === T.input ? parseFloat(t) || 0 : t + "",
                        z(u),
                        u.focus(),
                        E.hideLoading()
                    }).catch(function(t) {
                ...
                At(T),
                T.toast || (j(T.allowEnterKey) ? T.focusCancel && K(O.cancelButton) ? O.cancelButton.focus() : T.focusConfirm && K(O.confirmButton) ? O.confirmButton.focus() : a(-1, 1) : document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()),
    ...
    Object.keys(St).forEach(function(e) {
        Lt[e] = function() {
            var t;
            if (Pt)
                return (t = Pt)[e].apply(t, arguments)
        }
    }),
    Lt.DismissReason = t,
    Lt.version = "8.5.0";
